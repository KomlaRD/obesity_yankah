...
obesity <- obesity%>%
        ...
        marital_status = factor(marital_satus)%>%
...
```{r full-model}
full_model <- glm(obesity$obese_dummy ~ obesity$age_years + obesity$sex + obesity$educational_status + obesity$marital_satus+ obesity$religion + obesity$occupation + obesity$monthly_income, family = binomial)
```
